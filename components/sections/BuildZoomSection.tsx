export default function BuildZoomSection() {
  return (
      ...
      <div className="container" style={{ maxWidth: '800px', textAlign: 'center' }}>
        ...
        <div>
          <a
            ...
            target="_blank"
            rel="noopener"
            style={{ display: 'inline-flex', alignItems: 'center', gap: '10px', padding: '14px 32px', borderRadius: '999px', background: '#ea580c', color: '#fff', fontSize: '15px', fontWeight: '800', textDecoration: 'none', boxShadow: '0 8px 24px rgba(234,88,12,0.35)', transition: 'all 0.2s' }}
          >
        ...
        <style>{`
          @media (max-width: 600px) { .bz-grid { grid-template-columns: 1fr !important; } }
        `}</style>
      </div>
    </section>
  );

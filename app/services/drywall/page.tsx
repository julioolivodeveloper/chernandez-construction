...
import { PaintBucket, Phone, MapPin, CheckCircle2 } from 'lucide-react';

export const metadata: Metadata = {
  title: 'Drywall & Painting Contractor | C Hernandez Construction – Ceres & Modesto CA',
  description: 'Licensed drywall and painting contractor (Lic. #1106454) in Ceres and Modesto, CA. Drywall installation, texture and interior painting. Call (209) 241-3765.',
};

const types = [
  { title: 'Drywall Installation', desc: 'Hang and finish drywall for new construction, additions, remodels and ADUs.' },
  { title: 'Texture Application', desc: 'Smooth, orange peel, knockdown and skip trowel textures to match existing walls.' },
  { title: 'Drywall Repair', desc: 'Patch holes, cracks and water damage — seamlessly blended into existing surfaces.' },
  { title: 'Interior Painting', desc: 'Interior wall and ceiling painting after drywall work, in preparation for occupancy.' },
];

const faqs = [
  { q: 'Do you hang and finish drywall for new construction?', a: 'Yes. We handle drywall for new homes, ADUs, room additions and remodels from hang to finish coat.' },
  { q: 'What textures can you apply?', a: 'We apply smooth, orange peel, knockdown and skip trowel textures. We match existing texture when patching.' },
  { q: 'Do you paint after drywall?', a: 'Yes, we offer interior painting as part of the drywall and finish package.' },
  { q: 'What areas do you serve?', a: 'Ceres, Modesto, Turlock, Salida, Riverbank, Patterson and surrounding Central Valley areas.' },
  { q: 'Are you licensed for drywall work?', a: 'Yes. CA General Contractor License #1106454 covers drywall installation and interior painting.' },
];
      ...
      <section style={{ paddingTop: '140px', paddingBottom: '80px', background: 'linear-gradient(145deg, #040a16, #0a1428)' }}>
        <div className="container">
          ...
          <p style={{ fontSize: '17px', color: 'rgba(255,255,255,0.6)', lineHeight: 1.75, maxWidth: '600px', marginBottom: '32px' }}>
            Licensed drywall installation, texture and interior painting for new construction, ADUs, additions and remodels across the Central Valley.
          </p>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '16px' }}>
            {['CA License #1106454', 'Hang & Finish', 'Texture Matching', 'Interior Painting'].map(item => (

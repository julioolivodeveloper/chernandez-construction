      ...
      <section style={{ paddingTop: '140px', paddingBottom: '80px', background: 'linear-gradient(145deg, #040a16, #0a1428)' }}>
        <div className="container">
          ...
          <p style={{ fontSize: '17px', color: 'rgba(255,255,255,0.6)', lineHeight: 1.75, maxWidth: '600px', marginBottom: '32px' }}>
            Finish carpentry, baseboards, crown molding, built-ins and interior trim for new construction, ADUs, additions and remodels across the Central Valley.
          </p>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginTop: '24px' }}>
            ...
            <span style={{ fontSize: '13px', color: 'rgba(255,255,255,0.55)' }}>CA License #1106454 · Finish Carpentry Specialist · Free Estimates</span>
          </div>
        </div>
      </section>
